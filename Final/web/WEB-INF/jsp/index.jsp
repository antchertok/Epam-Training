                ...
                <%--<c:forEach var="drug" items="${drugList}">--%>
                    <%--<div class="panel panel-default">--%>
                        <%--<div class="panel-body">--%>
                            <%--<div class = "row">--%>
                                <%--<div class="col-sm-2" style="display: inline-block">${drug.name}</div>--%>
                                <%--<div class="col-sm-2" style="display: inline-block">--%>
                                    <%--<label>${drug.price} б.р.</label>--%>
                                <%--</div>--%>
                                <%--<div class="col-sm-1" style="display: inline-block">${drug.prescription}</div>--%>
                                <%--<div class="col-sm-5" style="display: inline-block">--%>
                                     <%--<form name="AddToCardForm" action="controller">--%>
                                         ...
                                         <%--<input type="number" required min="1" name="amount" value="" placeholder="amount"--%>
                                                <%--<c:if test="${empty sessionScope.user}">disabled title="Please enter the system" </c:if>/>--%>
